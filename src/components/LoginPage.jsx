  ...
  return (
    <div className={loginPageStyles.mainContainer}>
        ...
        <div className={loginPageStyles.loginCard}>
            ...
            <p className={loginPageStyles.subtitle}>Sign in to manage your profile and schedule</p>

            <form onSubmit={handleLogin} className={loginPageStyles.form}>
                  <input type='email' name='email' placeholder='Email Address' value={formData.email} onChange={handleChange} className={loginPageStyles.input} required />
                  <input type='password' name='password' placeholder='Password' value={formData.password} onChange={handleChange} className={loginPageStyles.input} required />
