    ...
    return (
        <div className={appointmentPageStyles.pageContainer}>
            ...
            <div className={appointmentPageStyles.maxWidthContainer}>
                ...
                {loadingDoctors && (
                    <div className={appointmentPageStyles.loadingText}>Loading Doctors...
                    </div>
                )}
                ...
                <div className={appointmentPageStyles.doctorGrid}>
                    {appointmentData.map((item) => (
                        <div key={item.id} className={cardStyles.doctorCard}>
                            ...
                            <div className={cardStyles.specialization}>{item.specialization}{" "}{item.experience ? `. ${item.experience}` : " "}</div>
                            <p className={cardStyles.dateContainer}>
                                <CalendarDays className={iconSize.medium} /> {item.date}</p>
             ...
             <h2 className={appointmentPageStyles.serviceTitle}>Your Booked Service </h2>
                {loadingServices && (
                    <div className={appointmentPageStyles.serviceLoadingText}>Loading Services...
                    </div>
                )}
